...
run: ./bin/main.out
	cat tests/test1 | mpirun -n 5 ./bin/main.out test1
	cat tests/K02-01-TC1 | mpirun -n 5 ./bin/main.out K02-01-TC1
	cat tests/K02-01-TC2 | mpirun -n 5 ./bin/main.out K02-01-TC2
	cat tests/K02-01-TC3 | mpirun -n 5 ./bin/main.out K02-01-TC3
	cat tests/K02-01-TC4 | mpirun -n 5 ./bin/main.out K02-01-TC4
